...
import { ActionMessage, ActionSection, Dialog, InputError, PrimaryButton, SecondaryButton, TextInput } from '@/Components';


const LogoutOtherBrowserSessions = ({ sessions }) => {
    ...
    return (
        ...
        >
            ...
            <Dialog isOpen={confirmingLogout} onClose={closeModal}>
                <Dialog.Content title={'Log Out Other Browser Sessions'}>
